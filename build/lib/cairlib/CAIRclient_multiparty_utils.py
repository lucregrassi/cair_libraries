from DialogueStatistics import *
from SpeakerInfo import *
import requests
import json
import time
import socket
...
BASE = "http://" + localhost + ":5000/CAIR_hub"
language = "it"


def compose_sentence(sentence_pieces):
    sentence = ""
...
def add_speaker_statistics(new_speaker_info):
...
def registration_procedure():
    ...
    speakers_info, dialogue_statistics = add_speaker_statistics(new_speaker_info)
    return speakers_info, dialogue_statistics
