...
class Utils:
    ...
    def explore_DT(self, dialogue_sentence, prev_topic_number, prev_topic_pattern, prev_topic_stop, ontology,
                   topics_familiarity, topics_sentences_flags, negative):
        ...
        if prev_topic_pattern:
            ...
            resp, topic_sentences_flags = self.choose_sentence(sentence_type, prev_topic_number, ontology,
                                                               ...
                                                               topics_familiarity[prev_topic_number])
            ...
            # If there is no sentence of that type for that topic, continue with the pattern
                ...
                return self.explore_DT(dialogue_sentence, prev_topic_number, prev_topic_pattern, prev_topic_stop,
                                       ontology,
                                       topics_familiarity, topics_sentences_flags, False)
        ...
        if sentence_type == 'n':
            ...
            return self.explore_DT(dialogue_sentence, prev_topic_number, prev_topic_pattern, prev_topic_stop, ontology,
                                   topics_familiarity, topics_sentences_flags, True)
    ...
    def explore_DT_openai(self, prev_topic_number, prev_topic_pattern, prev_topic_stop, ontology, topics_familiarity, negative):
    ...
    def start_new_pattern(self, topic_n, prev_topic_stop, ontology, topics_familiarity, topics_sentences_flags,
                          provide_opinion):
        sentence_type, prev_topic_pattern = self.choose_pattern(topic_n, topics_familiarity, ontology, provide_opinion)
        ...
        # If no initial sentence has been chosen, or the sentence is p because the topic familiarity is already 1, explore
